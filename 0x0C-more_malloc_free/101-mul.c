...
#include <stdio.h>
/**
 * _prt - printstring followed by newline
 * @s: string to print
 */
void _prt(char *s)
{
...
/**
 * _realloc - Re-allocate memory for a large or smaller size
...
void *_realloc(void *ptr, unsigned int old_size, unsigned int new_size)
{
	...
	if (space == NULL)
		return (NULL);
	/* if ptr is null, return space without copying it */
	if (ptr == NULL)
		return (space);
...
/**
 * _calloc - allocate momory and initialize space to zero
